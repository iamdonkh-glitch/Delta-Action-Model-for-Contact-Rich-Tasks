...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    # )
    agent_cfg["params"]["config"]["max_epochs"] = 50
    ...
    agent_cfg["params"]["config"]["full_experiment_name"] = "closeloop"
    ...
    base_cfg["params"]["load_checkpoint"] = True
    base_cfg["params"]["load_path"] = "logs/rl_games/Factory/delta_weighted_xyz/nn/last_Factoryep400rew[445.1203].pth"  # <-- set this
    base_cfg["params"]["config"]["num_actors"] = 64  # temp until real env exists
    ...
    base_cfg["params"]["config"]["env_name"] = "dummy"
    base_cfg["params"]["config"]["num_actors"] = 64
    runner1 = Runner()
    runner1.load(base_cfg)
    player = runner1.create_player()
    player.restore(base_cfg["params"]["load_path"])
    player.reset()
    ...
    env = gym.make(args_cli.task, cfg=env_cfg, render_mode="rgb_array" if args_cli.video else None, BaseAgent=player)
